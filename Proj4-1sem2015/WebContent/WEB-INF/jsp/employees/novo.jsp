...
<body>
	...
	<form action="./employees?logica=salvar" method="post">
		...
		<div class="form-group">
			<label for="txtLastName">Ultimo Nome:</label> <input type="text"
				id="txtLastName" name="lastName" class="form-control" />
		</div>
		<div class="form-group">
			<label for="txtEmail">Email:</label> <input type="text" id="txtEmail"
				name="email" class="form-control" />
		</div>
		<div class="form-group div20">
			<label for="txtHireDate">Admissão:</label> <input type="text"
				id="txtHireDate" name="hireDate" class="form-control" />
		</div>

		<div class="form-group div20">
			<label for="txtJobId">Job.Id:</label> <input type="text"
		...
		<div class="form-group div20">
			<label for="txtDepartment">ID do Departamento:</label> <input
				type="text" id="txtDepartmentId" name="departmentId"
				class="form-control" />
		</div>

		<div class="form-group div20">
			<label for="txtManagerId">ID do Gerente:</label> <input type="text"
